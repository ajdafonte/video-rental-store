...
//    }
    ...
    void givenExistentId_whenGetFilmById_thenReturnExistentFilm() throws Exception
    {
        ...
        // when
        final ResultActions result = mvc.perform(get(FILM_BY_ID_URI, String.valueOf(expectedFilm.getId()))
            .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE));
    ...
    {
        // given
        final InsertFilmRequestBody parameter = FilmTestHelper.generateInsertFilmRequestBody("To infinity and beyond");
    ...
    {
        // given
        final InsertFilmRequestBody parameter =
